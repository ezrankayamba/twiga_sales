...
import { IconPerson, IconSettings, IconSignOut } from "neza-react-forms";
              ...
              <div className="input-group hidden-xs-down wd-170 transition">
                ...
                <span className="input-group-btn">
                  <button className="btn btn-secondary" type="button">
                    <i className="ion ion-ios-search-strong tx-24"></i>
                  </button>
                </span>
              </div>
            </>
        ...
        <div className="br-header-right">
              ...
              <div className="dropdown">
                ...
                <div className="dropdown-menu dropdown-menu-header wd-300 pd-0-force">
                  <div className="d-flex align-items-center justify-content-between pd-y-10 pd-x-20 bd-b bd-gray-200">
                    <label className="tx-12 tx-info tx-uppercase tx-semibold tx-spacing-2 mg-b-0">
                      Notifications
                    </label>
                    <a href="" className="tx-11">
                      Mark All as Read
                    </a>
                  </div>
          ...
          {!loggedIn && (
            <div className="nav pr-3">
              <a href="/login">
                <i className="icon ion-power"></i> Sign In
              </a>
            </div>
          )}
        </div>
