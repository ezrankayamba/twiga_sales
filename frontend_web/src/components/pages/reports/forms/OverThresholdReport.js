...
const OverThresholdReport = ({ user }) => {
  ...
  useEffect(() => {
    CRUD.list("/reports/over-threshold-days", user.token, {
      onSuccess: (res) => {
        console.log(res);
  ...
  const onSearch = (params) => {
    CRUD.search("/reports/over-threshold-days", user.token, params, {
      onSuccess: (res) => {
        console.log(res);
        setSales(res.data.map(mapSaleRecord));
      },
...
export default OverThresholdReport;
